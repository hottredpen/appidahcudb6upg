...
<form method="post"  action='__URL__/email_send'>
<table class="table table-hover">
            ...
            <tbody>
                ...
                <td>
				  <input name="smtp" class="form-control" type="text" value="<?php echo ($vo["0"]["smtp"]); ?>" />
                </td>
              </tr>
            </tbody>
            <tbody>
                ...
                <td>
                	<label><input type="radio" name="validation" value="1"  checked/>是</label>
                  	<label><input type="radio" name="validation" value="0"  />否</label>
                </td>
              </tr>
            </tbody>
            <tbody>
                ...
                <td>
				  <input name="send_email" class="form-control" type="text" value="<?php echo ($vo["0"]["send_email"]); ?>" />
                </td>
              </tr>
            </tbody>
            <tbody>
                ...
                <td>
				  <input name="password" class="form-control" type="password" value="<?php echo ($vo["0"]["password"]); ?>" />
                </td>
              </tr>
            </tbody>
            <tbody>
                ...
                <td>
				  <input name="addresser" class="form-control" type="text" value="<?php echo ($vo["0"]["addresser"]); ?>" />
                </td>
              </tr>
            </tbody>
          </table>
