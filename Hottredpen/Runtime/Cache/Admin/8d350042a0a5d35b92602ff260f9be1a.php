	...
	<div id="content" class="col-md-10">
		<ul class="breadcrumb">
			...
			<div class="pull-right">
			    <a href="#" data-toggle="modal" data-target="#myModal" >添加管理员 </a>
			</div>
		</ul>
            ...
            <tbody>
			 <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <?php if($vo["time"] != 0 ): ?><td><?php echo (date("Y-m-d",$vo["time"])); ?></td>
                <?php else: ?>
                <td>无</td><?php endif; ?>
                <td>
                  <a href="#edit" data-toggle="modal" data-target="#editmyModal" onclick="editadmin(<?php echo ($vo["id"]); ?>)" >编辑</a>
                  <a href="#" onclick="if(confirm('是否要删除？'))window.location.href='__URL__/exitman?id=<?php echo ($vo["id"]); ?>'">删除</a>
                </td>
			...
			<table class="table">
							<tbody>
							  ...
							  <tr>
								...
								<td>
								  <input name="email" type="text" class="form-control" placeholder="请输入eamil...">
								</td>
							  </tr>
							  <tr>
								<td>
...
function editadmin(id){
		$("#editss").load("/index.php?g=Admin&m=user&a=adminajax", {id:id});
}
</script>
<div class="clean"></div>
</body>
